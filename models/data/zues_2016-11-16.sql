...
-- ----------------------------
BEGIN;
INSERT INTO `zn_device` VALUES ('1', 'hostname', '192.168.1.2', 'windows', 'def', '这是描述信息12', '0'), ('43', 'http-server3', '101.200.174.134', 'default', 'default', '批量保存设备', '0'), ('44', 'http-server1', '101.200.174.134', 'default', 'default', '批量保存设备', '0'), ('45', 'http-server4', '101.200.174.134', 'default', 'default', 'dddd', '0');
COMMIT;
...
CREATE TABLE `zn_device_group` (
  ...
  `description` text COMMENT '描述',
  `type` tinyint(4) DEFAULT '0' COMMENT '分组类型，0菜单，>=1其它',
...
-- ----------------------------
BEGIN;
INSERT INTO `zn_device_group` VALUES ('1', 'name1', '0', '简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介', '3', '0'), ('2', 'name2', '1', 'hehe', '3', '0'), ('3', '测试1', '0', '测试1描述', '3', '0'), ('4', 'name3', '1', 'name3name3', '3', '0'), ('5', 'name4', '1', 'name4name4', '3', '0'), ('6', 'name5', '4', 'name5333', '3', '0'), ('7', '测试2', '3', '测试2', '3', '0'), ('8', '测试一下', '0', '测试一下测试一下', '2', '0'), ('9', '测试一下1', '8', '测试一下1', '2', '0'), ('10', '测试一下2', '8', '测试一下2', '2', '0'), ('11', '测试一下3', '9', '测试一下3', '2', '0');
COMMIT;
...
CREATE TABLE `zn_device_group_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='设备分组的分组';

-- ----------------------------
--  Records of `zn_device_group_group`
-- ----------------------------
BEGIN;
INSERT INTO `zn_device_group_group` VALUES ('1', '菜单分组'), ('2', '分组1'), ('3', '分组2'), ('4', '分组3'), ('5', '分组4'), ('6', '分组5');
COMMIT;
