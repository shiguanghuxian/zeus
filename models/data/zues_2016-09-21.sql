...
CREATE TABLE `zn_event_seting` (
  ...
  `cycle_time` int(11) DEFAULT '300' COMMENT '执行周期，每个多少秒执行一次策略',
...
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_seting` VALUES ('1', 'name1', 'appname1', 'field1', '统计值', 'desc11', '21', '31', '41', '1', '1', '0'), ('2', '测试标题', '应用名', '字段', '统计值', '描述', '1', '60', '300', '3', '1', '0');
COMMIT;
