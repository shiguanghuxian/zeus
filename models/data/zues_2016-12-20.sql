...
-- ----------------------------
BEGIN;
INSERT INTO `zn_appname_field_type` VALUES ('1', 'zn_raw_data', 'code', 'string', null, '0', '0'), ('2', 'zn_raw_data', 'value', 'int', null, '0', '0'), ('6', 'zn_hehe', 'value', 'int64', 'Mb', '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_push` VALUES ('1', '1', 'http://www.baidu2.com', '测试推送2', '1'), ('6', '2', 'http://www.baidu.com', 'ces45', '1');
COMMIT;
...
CREATE TABLE `zn_event_rule` (
  ...
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='告警规则';

-- ----------------------------
--  Records of `zn_event_rule`
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_rule` VALUES ('6', '3', '2', '10', '<=', '1', '%'), ('7', '4', '1', '33', '=', '0', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_seting` VALUES ('1', 'name1', 'appname1', 'field1', '统计值', 'desc11的速度', '21', '31', '*/30 * * * * *', '1', '1', '0'), ('2', '测试标题', '应用名', '字段', '统计值', '描述是多少', '1', '60', '* */5 * * * *', '3', '1', '0');
COMMIT;
