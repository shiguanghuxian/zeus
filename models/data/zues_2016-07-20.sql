...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='字段格式配置';
...
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='配置nsq消息处理规则';
...
CREATE TABLE `zn_topics_config_rule` (
  ...
  KEY `sort` (`sort`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='话题规则配置';
