...
-- ----------------------------
BEGIN;
INSERT INTO `zn_appname_field_type` VALUES ('1', 'zn_raw_data', 'code', 'string', null, '0', '0'), ('2', 'zn_raw_data', 'value', 'int', 'Mb', '0', '0'), ('6', 'zn_hehe', 'value', 'int64', 'Mb', '0', '0');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='告警规则设备列表';

-- ----------------------------
--  Records of `zn_event_device`
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_device` VALUES ('7', '2', '1'), ('8', '2', '43'), ('10', '1', '45'), ('11', '2', '44'), ('13', '1', '43'), ('14', '1', '44');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_push` VALUES ('1', '1', 'http://www.baidu.com', '测试推送2', '1'), ('6', '2', 'http://www.baidu.com', 'ces45', '1');
COMMIT;
...
CREATE TABLE `zn_event_rule` (
  ...
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='告警规则';

-- ----------------------------
--  Records of `zn_event_rule`
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_rule` VALUES ('6', '3', '2', '10', '<=', '0', '%'), ('7', '4', '1', 'this is code', '=', '0', ''), ('9', '6', '2', '90', '>=', '1', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_seting` VALUES ('1', 'name1', 'zn_raw_data', 'code', '当前值', 'desc11的速度', '21', '31536000', '0 */1 * * * *', '1', '1', '0'), ('2', '测试标题', 'zn_raw_data', 'value', '最大值', '描述是多少', '1', '31536000', '@every 10s', '3', '1', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `zn_event_template` VALUES ('1', 'name', '告警触发值{current_value}、告警时间{date}、告警级别{event_level}、主机名{hostname}、ip地址{ip}、分组{group}等'), ('2', 'name1', 'content1'), ('3', 'ee22', 'ewewe22的速度');
COMMIT;
