...
CREATE TABLE `zn_device_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='设备分组';

-- ----------------------------
--  Records of `zn_device_group`
-- ----------------------------
BEGIN;
INSERT INTO `zn_device_group` VALUES ('1', 'name1', '简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介', '3', '0');
COMMIT;
